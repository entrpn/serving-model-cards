# Original file from https://github.com/huggingface/diffusers/blob/main/examples/dreambooth/train_dreambooth_flax.py
import argparse
import hashlib
import logging
import math
...
def main():
    ...
    if args.with_prior_preservation:
        ...
        if cur_class_images < args.num_class_images:
            ...
            if args.sample_batch_size < jax.device_count():
                args.sample_batch_size = jax.device_count()

# Original https://github.com/huggingface/diffusers/blob/main/examples/text_to_image/train_text_to_image_flax.py
import argparse
import logging
import math
import os
...
def main():
    ...
    tokenizer = CLIPTokenizer.from_pretrained(args.pretrained_model_name_or_path, revision='bf16', 
